...
import twitter4j.configurationbuilder.CustomConfigurationBuilder;
...
public final class ShowUser {
    ...
    public static void main(String[] args) {
        /*if (args.length < 1) {
    	  ...
    	  CustomConfigurationBuilder ccb = new CustomConfigurationBuilder();
          ConfigurationBuilder cb =ccb.getConfigurationBuilder();
          
        try {
            Twitter twitter = new TwitterFactory(cb.build()).getInstance();
            User user = twitter.showUser("talk2sharn");
